...
- **Displays Greetings from backend api**
...
3. Clone this repo 
```
git clone https://github.com/mershark/hello-react-front-end.git
...
Feel free to check the [issues page](https://github.com/mershark/hello-react-front-end/issues).
